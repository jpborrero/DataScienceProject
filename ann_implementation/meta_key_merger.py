...
cols_0 = ['id', 'vote_average', 'genres', 'budget', 'revenue', 'popularity']
cols_1 = ['id', 'keywords']
...
if discretized:
	...
	meta = pd.read_csv(meta_filen, usecols=cols, converters={'genres':JSONParser, 'production_companies':alternateJSONParser})
